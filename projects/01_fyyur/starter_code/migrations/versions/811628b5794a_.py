...
Revision ID: 811628b5794a
Revises: 
Create Date: 2019-12-05 10:05:59.929662
...
def upgrade():
    ...
    sa.Column('seeking_venue', sa.Boolean(create_constraint=300), nullable=True),
