...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.database_path = "postgres://{}/{}".format('postgres:password@127.0.0.1:5432', self.database_name)
    ...
    def test_create_questions(self):
        ...
        res = self.client().post('/questions',json={"question":"What is chemical composition of water",
        "answer":"H2O","category":1,"difficulty":2})
        data = json.loads(res.data)
        self.assertEqual(res.status_code, 200)
        self.assertEqual(data['success'], True)
    ...
    def test_405_create_question_not_allowed(self):
        ...
        res = self.client().post('/questions/95',json={"question":"What is chemical composition of water",
        "answer":"H2O","category":1,"difficulty":2})
        data = json.loads(res.data)
    ...
    def test_delete_question(self):
        """Test API to delete question for question id passed as request argument(DELETE request). """
    ...
    def test_search_questions(self):
        """TEST API to search questions with search term as request argument """
